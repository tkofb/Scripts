...
LAT = "38.363350"
LONG = "-75.605919"
API_KEY = "4cf3731a25d1d1f4e4a00207afd451a2"
UNITS = "imperial"
#UNIT_KEY = "C"
UNIT_KEY = "F"
LANG = "en"
...
REQ = requests.get("http://api.openweathermap.org/data/2.5/weather?lat={}&lon={}&lang={}&appid={}&units={}".format(LAT, LONG, LANG,  API_KEY, UNITS))
try:
    # HTTP CODE = OK
